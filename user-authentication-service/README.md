...
A robust User Authentication Service built with Spring Boot, providing secure user registration, login, and password management functionalities using JWT (JSON Web Tokens).
