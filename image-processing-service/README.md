...
A scalable Image Processing Microservice built with Spring Boot. This service supports image uploading, resizing, compression, format conversion (including WebP, TIFF, BMP, ICO), and thumbnail generation.
