...
A Spring Boot application that acts as a wrapper around the OpenWeatherMap API. It provides a simplified RESTful
interface to retrieve current weather information for a specific city.
