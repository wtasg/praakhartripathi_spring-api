...
A scalable Feedback & Review System built using Spring Boot, JPA, and PostgreSQL. This system allows users to submit reviews for products, enforcing a unique review per user per product rule, and provides APIs for retrieving reviews and calculating average ratings.
